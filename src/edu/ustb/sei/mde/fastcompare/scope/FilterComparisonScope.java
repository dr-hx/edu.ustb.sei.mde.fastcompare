...
import edu.ustb.sei.mde.fastcompare.utils.Predicates;

import static java.util.Collections.*;

public class FilterComparisonScope extends AbstractComparisonScope {
    /**
     * This will be used in order to determine the filter that should be used to
     * filter the EObjects' content
     ...
     * @param origin
     *               The common ancestor of <code>left</code> and
     *               <code>right</code>. May be <code>null</code>.
     */
     ...
     * {@inheritDoc}
     * <p>
     * This default implementation will only return the {@link Resource}s directly
     * contained by
     * {@link ResourceSet} which match the {@link #resourceSetContentFilter}
     * predicate.
     * </p>
     * 
    ...
    public Iterator<? extends Resource> getCoveredResources(ResourceSet resourceSet) {
        ...
        final Iterator<Resource> filter = filter(allResources, resourceSetContentFilter);
     ...
     * {@inheritDoc}
     * <p>
     * This default implementation will return all direct and indirect content of
     * the given {@link Resource},
     * filtering out those {@link EObject}s that do not match
     * {@link #resourceContentFilter}.
     * </p>
     * 
    ...
    public Iterator<? extends EObject> getCoveredEObjects(Resource resource) {
        ...
        final Iterator<EObject> filter = filter(properContent, resourceContentFilter);
    ...
    public Iterator<? extends EObject> getChildren(EObject eObject) {
        ...
        final Iterator<EObject> filter = filter(properContent, eObjectContentFilter);
    ...
    /**
     * This can be used to set the filter that should be used to filter the
     * EObjects' content list of
     * unnecessary values. By default, we will use an "always true" predicate : the
     * list won't be filtered out
     * unless this is called with a new filter.
     * 
     * @param newContentFilter
     *                         The filter that should be used for EObject content
     *                         filtering.
     */
    ...
    /**
     * This can be used to set the filter that should be used to filter the
     * Resources' content list of
     * unnecessary values. By default, we will return an "always true" predicate :
     * the list won't be filtered
     * out unless this is called with a new filter.
     * 
     * @param resourceContentFilter
     *                              The filter that should be used for Resource
     *                              content filtering.
     */
    ...
    /**
     * This can be used to set the filter that should be used to filter the
     * ResourceSets' content list of
     * unnecessary values. By default, we will return an "always true" predicate :
     * the list won't be filtered
     * out unless this called with a new filter.
     * 
     * @param resourceSetContentFilter
     *                                 The filter that should be used for
     *                                 ResourceSet content filtering.
     */
    ...
    /**
     * Tries and register the URI of the given object as one of this scope's
     * resources. Note that we only
    ...
    /**
     * This iterator enables to add in the iteration the initialization of the
     * namespace and resource uris
     * set.
     * 
